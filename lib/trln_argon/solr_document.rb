...
module TrlnArgon
  ...
  module SolrDocument
    ...
    # "Record is considered local to..."
    # Expected to be one of: duke, unc, nscu, nccu, trln
    # Used to group records for display purposes
    ...
    # Used to lookup location codes. Also, used to
    # set record_association.
